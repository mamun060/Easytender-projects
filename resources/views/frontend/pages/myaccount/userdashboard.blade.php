        ...
        <div class="col-md-3">
            <div class="account-menu-list">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Vat List</button>
        ...
        <div class="col-md-9">
            <div class="right-content-wrap shadow p-2 ">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-all-tender" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                        <div class="data-table-wrap">
                    ...
                    <div class="tab-pane fade" id="v-pills-profile-edit" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                        Edit Profile
                    </div>
